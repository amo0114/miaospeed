...
const (
	...
	SPEED_DEFAULT_UPLOAD_URL                 string = "https://speed.cloudflare.com/__up"

	SPEED_DEFAULT_LARGE_FILE_DYN_INTL string = "DYNAMIC:INTL"
	SPEED_DEFAULT_LARGE_FILE_DYN_FAST string = "DYNAMIC:FAST"

	SPEED_DEFAULT_UPLOAD_URL_DYN string = "DYNAMIC:INTL"
	...
	SPEED_DEFAULT_UPLOAD_SIZE      = 1024 * 1024 * 1024 // 1GB
)
